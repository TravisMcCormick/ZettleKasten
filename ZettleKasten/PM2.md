...
- **Process management**
    ...
    - Supports hot reloads and zero-downtime restarts via the `pm2 reload` command.
...
In short, PM2 sits between your Node processes and the OS’s init system, providing advanced clustering, automatic recovery, logging, and deployment helpers—all in a single, easy-to-use tool.
